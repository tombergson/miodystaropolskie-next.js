  ...
  return (
    <section className="py-12 px-6 max-w-6xl mx-auto my-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        ...
        >
          <div className="text-amber-500 mb-3 group-hover:text-amber-600 transition-colors duration-300 transform group-hover:-translate-y-1">
            <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
            </svg>
          </div>
          <h3 className="text-base font-serif font-bold text-stone-800 mb-1 group-hover:text-amber-600 transition-colors">
