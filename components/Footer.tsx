...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-honey/30 bg-cream text-stone-600">
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-3 md:items-baseline">
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-widest text-honey-dark">
            Nawigacja
          </p>
      ...
      <div className="border-t border-honey/20 bg-white/60 px-6 py-6 text-center text-xs text-stone-600 flex flex-col items-center justify-center gap-2">
