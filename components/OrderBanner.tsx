  ...
  return (
    <section className="relative py-20 px-6 w-full overflow-hidden border-y border-stone-200/80 shadow-xs">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto text-white">
        <h2 className="text-2xl md:text-4xl font-playfair font-bold mb-4 tracking-tight">
          Zamówienie na tegoroczny miód
        </h2>
        <div className="w-20 h-1 bg-honey rounded-full mb-4"></div>
        ...
        <Link
          href="/kontakt"
          className="inline-flex items-center justify-center rounded-xl bg-honey px-7 py-3 text-sm md:text-base font-semibold text-stone-900 shadow-lg hover:bg-honey-dark transition-all duration-300 transform hover:-translate-y-0.5"
        >
